...
@Component({
    ...
    templateUrl: './gs-sng-network-topology.component.html',
    styleUrls: [
        './gs-sng-network-topology.component.css'
    ]
})
export class GsSngNetworkTopologyComponent implements OnInit, AfterViewInit {

    @ViewChild('sngNetwork', {static: true}) public myDiagramComponent?: DiagramComponent;
    ...
    _processData() {
        ...
        console.log('Network state :', this.topologyData.topology, this.topologyData, this.state);
    }
    ...
    public initDiagram = () : go.Diagram  => {
        ...
        const dia = $(go.Diagram, {
            ...
            layout: $(go.ForceDirectedLayout, {defaultSpringLength: 10, defaultElectricalCharge: 100}),
    ...
    ngAfterViewInit(): void {
        ...
        const component: GsSngNetworkTopologyComponent = this;
